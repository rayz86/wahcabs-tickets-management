...
export default function GSTGoaInvoice({ ticket, ticketId, bookingType, totalAmount, partyName, partyGST, sgst, cgst }) {
      ...
      <div className="grid grid-cols-2 text-xs mt-6">
        <div>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Invoice is valid only on successful trip completion.</li>
